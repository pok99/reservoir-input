...
dsets = ['datasets/rsg-sohn-100-150.pkl', 'datasets/rsg-sohn-150-200.pkl']
...
color_scale = ['tomato', 'cornflowerblue', 'orchid']
...
for j, dset in enumerate(dsets):
    ...
    ax.errorbar(stats[0], stats[1], yerr=stats[2], marker='o', color=color_scale[j], mfc=color_scale[j], mec='black', ms=8, label=dset_names[j], elinewidth=1)
